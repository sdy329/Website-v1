    ...
    return (
        <div className="grid justify-center lg:justify-start text-center lg:text-start">
            <span className="lg:frame mx-auto lg:ml-28">
                <img src="./src/img/profile.png" className="block h-36" />
            </span>
            ...
            <p className="max-w-xs leading-normal mx-auto lg:mx-0">sed odio morbi quis commodo odio aenean sed adipiscing diam</p>
        </div>
    )
}